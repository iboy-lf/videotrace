...
- 本地 `121 passed, 1 skipped`、iboy 标准入口 `122 passed`，interview `17/17`，delivery `40/40`；最终 artifact manifest 包含 51 个核心制品和 14 份不可变准入历史，本地 manifest hash mismatch 为 0，关键 checkpoint、数据、metrics、模型卡、canonical 和 registry 双端逐项一致。
