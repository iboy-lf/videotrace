...
- [x] 本地 pytest `121 passed, 1 skipped`、iboy pytest `122 passed`；compileall、4 个 JS syntax、3 个行为测试通过
- [x] interview `17/17`；delivery `40/40`；source/video/data/checkpoint/adapter/report hash 可审计
