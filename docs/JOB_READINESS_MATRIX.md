...
| 荣耀大模型算法 | LLM/VLM/Agent 统一链路、5/5 错误回归、DPO 准入与 SFT 回退、冷 27.559s/热 14.901s（1.849×）、21/21 缓存命中、20260820 快照 40/40 交付校验 | ASR 未部署；不声称从零预训练、通用 entailment 或公开榜单领先；性能与交付数字属于 20260820 快照，当前树 delivery 为 34/40，待按 `docs/REVALIDATION.md` 重跑 |
